            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Made with Laravel 5.4</h3>
                        <p class="text-muted">This applicatoin was created from Laravel 5.4 so the notificaiton system is used along with the new Auth controllers that were introduced in Laravel 5.4</p>
